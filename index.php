   ...
   <?php include('layouts/header.php');?>      
         ...
         <!--Home-->
          <section id="home" >
            <div class="container">
              <h5><span2>New Arrivals</span2></h5>
              <h1><span>Best Prices</span> <span1>This Season</span1></h1>
          ...
          <section id="brand" class="container">
            <h3><span>Different Brands products on sale</span></h3>
            <div class="row">
          ...
          <section id="new" class="w-100">
            <div class="row p-0 m-0">
              ...
              <!--Two-->
              <div class="one col-lg-4 col-md-12 col-sm-12 p-0">
                <img class="img-fluid" src="assets/imgs/0.jpg"/>
                <div class="details">
          ...
          <section id="featured" class="my-5 pb-5">
            <div class="container text-center mt-5 py-5">
              <h3>Our Features</h3>
              <hr class="mx-auto">
              <p>Here you can check-out our new feature products</p>
            </div>
