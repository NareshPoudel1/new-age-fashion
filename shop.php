...
//1.determine page number while search
if(isset($_GET['page_no']) && $_GET['page_no'] != ""){
 ...
 //2.return number of products while search
 ...
 //3.set the total number of products to display per page while search
 ...
 //4.get all products after searched
 ...
 //return all products
  ...
  //3.set the total number of products to display per page
   $total_records_per_page = 8;
   $offset = ($page_no-1) * $total_records_per_page;
   $previous_page = $page_no - 1;
   $next_page = $page_no + 1;
                  ...
                  <div class="row mx-auto container">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                     ...
                     <p>Category</p>
                      ...
                      <div class="form-check">
                        <input class="form-check-input" value="bag" type="radio" name="category" id="category_two" <?php if(isset($category) && $category=='bags'){echo 'checked';}?>>
                        <label class="form-check-label" for="flexRadioDefault2">
                          Bags
                        </label>  
                      </div>
